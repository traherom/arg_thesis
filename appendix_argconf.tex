...
\lstinputlisting[caption=main.conf]{../arg/conf/main-gateA.conf}
...
\lstinputlisting[caption=gateA.pub, label=lst:ex_pub, breakatwhitespace=false]{../arg/conf/gateA.pub}
\lstinputlisting[caption=gateA.priv, label=lst:ex_priv, breakatwhitespace=false]{../arg/conf/gateA.priv}
\tbd{get these to wrap}
