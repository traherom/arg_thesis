...
\par The \texttt{--output} option here is the same as \texttt{gen\_traffic.py}'s and is covered in Table \ref{tbl:gen_traffic_param}. This is the only option supported by the malicious traffic generator.
