...
\section{IPv6 Packet Structure}
\label{sec:ipv6}


\section{IP Routing}
\label{sec:routing}
\par This thesis makes the assumption that the reader has a familiarity with how Internet Protocol (IP). This section, however, discusses how actual routing occurs with 

\par IPv4 address space is divided into 
