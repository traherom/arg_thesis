...
\graphicspath{{diagrams/},{afit-images/}} % reduce clutter by storing figures elsewhere
...
\abstract[\input{short_abstract}]{\input{abstract}}
...
\SponsoringAgency{INTENTIONALLY LEFT BLANK} % sponsor address or '\relax' (will appear blank)
...
\SubjectTerms{Networks, address space randomization, IP hopping, routing}
\ResponsiblePerson {Dr. Barry E. Mullins}  % advisors 4 digit extension. 
