...
\floatstyle{plaintop}
\newfloat{combined}{thp}{lop}
\floatname{combined}{Combined}
...
\designator{AFIT/GCO/ENG/13-M} % assigned by the graduate advisor in
...
\makePrefatoryPages 
\tbd{when you're crazy bored, fix acronyms/abbrevations to produce the listofacronyms style page}
