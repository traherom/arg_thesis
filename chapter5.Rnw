...
\begin{figure}
\caption{Basic Tests, Valid Packet Loss Means and \acp{CI}}
...
\begin{figure}
\caption{Hop Rate Tests, Traffic between \ac{ARG} Networks Only Loss Rate}
...
\begin{figure}
\caption{Hop Rate Tests, \ac{TCP} Traffic Only Loss Rate}
...
\begin{figure}
\caption{Hop Rate Tests, Externally-Bound Packet Loss Rate}
